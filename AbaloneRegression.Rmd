...
In equation (1), $R$ is the number of rings the abalone has, the $w$'s are the weights (our fitted parameters) and the $x_i$'s are the independent variables.  The independent variables can be described as: ${x_1}$ = M, ${x_2}$ = F, ${x_3}$ = Length, ${x_4}$ = Diameter, ${x_5}$ = Height, ${x_6}$ = Whole weight, ${x_7}$ = Shucked weight, ${x_8}$ = Viscera weight, and ${x_9}$= Shell weight.
